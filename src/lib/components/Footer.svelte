    ...
    <div class="grid md:grid-cols-4 gap-12 mb-12">
      <div class="md:col-span-1">
        ...
        <p class="text-white/60 text-sm leading-relaxed">
          Visión con estilo. Cuidado profesional para tus ojos.
        </p>
      </div>
      <div>
        ...
        <ul class="space-y-3">
          <li>
            <a
              href="#colecciones"
              class="text-white/60 text-sm hover:text-accent-yellow transition-colors"
              >Colecciones</a
            >
          </li>
          <li>
            <a
              href="#tecnologia"
              class="text-white/60 text-sm hover:text-accent-yellow transition-colors">Tecnología</a
            >
          </li>
          <li>
            <a
              href="#servicios"
              class="text-white/60 text-sm hover:text-accent-yellow transition-colors">Servicios</a
            >
          </li>
          <li>
            <a
              href="#galeria"
              class="text-white/60 text-sm hover:text-accent-yellow transition-colors">Galería</a
            >
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul class="space-y-3">
          ...
          <li>
            <span class="text-white/60 text-sm">Adaptación de Monturas</span>
          </li>
          <li>
            <span class="text-white/60 text-sm">Lentes de Contacto</span>
          </li>
          <li>
            <span class="text-white/60 text-sm">Lentes Digitales</span>
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul class="space-y-3">
          ...
          <li class="text-white/60 text-sm">{business.address}</li>
        </ul>
