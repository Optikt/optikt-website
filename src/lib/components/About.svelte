  ...
  <div class="max-w-7xl mx-auto px-6 md:px-12">
    <div class="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div use:fadeIn={{ type: 'right' }}>
        ...
        <p class="text-navy-300 mt-4 leading-relaxed">Nuestro equipo y asesores de estilo trabajan juntos para ofrecerte una atención integral.</p>
