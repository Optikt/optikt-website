...
export const business: BusinessData = {
  ...
  socialLinks: [
    ...
    {
      href: 'https://www.facebook.com/profile.php?id=61579277669006',
      label: 'Facebook',
  ...
  mapsUrl: 'https://maps.google.com/?q=9.7423948,-63.1673749',
  ...
  mapsSearchUrl: 'https://www.google.com/maps/search/?api=1&query=Optik-T+Maturin',
  timezoneOffset: -4,
  hours: [
