...
<div class="flex gap-3" class:mt-6={variant === 'text'}>
  ...
  <a href="#" aria-label="Twitter" class={linkClass}>
  ...
  {#if variant === 'circles'}
    <a href="https://wa.me/584121145790" target="_blank" rel="noreferrer" aria-label="WhatsApp" class="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 bg-white/5 border border-white/10 text-white/60 hover:bg-green-500 hover:text-white hover:border-green-500">
